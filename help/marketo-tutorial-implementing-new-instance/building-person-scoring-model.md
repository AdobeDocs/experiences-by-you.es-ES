...
**Paso 2** - Enumerar acciones que indican que un cliente potencial no está interesado en su producto. Asegúrese de enumerar las actividades de las que se puede realizar un seguimiento mediante Marketo Engage.

**Ejemplo 1a - Actividades que indican intención de compra**

| **Actividades que indican intención de compra** | **Actividades que indican SIN intención de comprar** |
| --- | --- |
...
**Paso 3** - Analice y elija una puntuación de umbral de entrega de ventas.
...
**Ejemplo 1b - Umbral de traspaso de ventas:**

| Cantidad promedio de puntos de contacto para posible cliente cualificado | 4 |
| --- | --- |
| Umbral de traspaso de ventas | 50 |

**Paso 4** - Asigne una puntuación a cada actividad enumerada en &quot;Ejemplo 1a - Actividades que indiquen intención de compra&quot;.
...
**Paso 5** - Recuerde, la puntuación es un proceso iterativo! Revise y ajuste continuamente las puntuaciones y los umbrales a medida que recopila más datos para su análisis.
...
**Paso 1** - Haga una lista de características para sus clientes potenciales ideales.
...
**Ejemplo 2a - Características de perspectiva ideal**
...
**Paso 2** - Asigne una puntuación a cada característica según su relevancia en el perfil ideal del cliente potencial. Utilice puntuaciones positivas para rasgos deseables y negativas para rasgos que hacen que el posible cliente sea menos adecuado para su producto.

**Ejemplo 2b - Asignación de puntuaciones a características de cliente potencial ideales e indeseables**

| **Característico** | **Puntuación** |
| --- | --- |
...
**Paso 1** - Tomar las actividades y características de los ejercicios 1 y 2 y determinar para cada artículo si varían por ubicación o línea de producto.
...
| Características | <ul><li>Departamento</li><li>Cargo</li></ul> | <ul><li>Industria</li><li>Tamaño de empresa</li></ul> |

**Paso 2** - Defina la matriz de puntuación para los mercados locales:
...
| Valores medios | 10 puntos | 7 puntos | 3 puntos |
| Valores bajos | 5 puntos | 3 puntos | 1 punto |

**Paso 3** - Recopile información de sus equipos de ventas locales o regionales para desarrollar una visión integral. Observará que en el ejemplo 3c no se incluyen puntuaciones individuales. Esto permite al equipo de ventas centrarse en el valor relativo de los diferentes temas durante el proceso de revisión. Sin embargo, debería tener el modelo completo documentado como material de fondo para otros administradores de Marketo Engage.
...
* Descargue la [hoja de ejercicios de puntuación de persona](./assets/build-person-scoring-model-and-local-flexibility-in-adobe-marketo-engage.docx){target="_blank} para desarrollar el modelo de puntuación sin conexión.
* Genere la puntuación de su persona en Marketo Engage. Marque esto [tutorial](https://experienceleague.adobe.com/en/docs/marketo-learn/tutorials/lead-and-data-management/lead-scoring-watch){target="_blank} y [demostración](https://experienceleague.adobe.com/en/docs/events/marketo-and-mochas-recordings/2023/lead-scoring){target="_blank} para empezar. Puede importar un programa de puntuación de posible cliente/persona [plantilla](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/core-marketo-concepts/programs/working-with-programs/import-a-program){target="_blank} de la Biblioteca de referencia del Marketo Engage para acelerar la compilación del programa.
...
* Pruebe la campaña inteligente una vez que haya terminado de crear el programa. Por ejemplo, vaya al formulario de demostración, rellénelo con un correo electrónico de prueba y compruebe la puntuación de la persona de prueba en [base de datos Marketo Engage](https://experienceleague.adobe.com/en/docs/marketo/using/getting-started-with-marketo/quick-wins/simple-scoring#step-view-the-person-info){target="_blank}.
* Después de crear el modelo, considere la posibilidad de configurar una alerta para que salga a ventas una vez que la puntuación de la persona haya alcanzado el umbral de transferencia de ventas. Obtenga más información sobre cómo configurar una alerta con esta [tutorial](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/core-marketo-concepts/smart-campaigns/flow-actions/send-alert){target="_blank}.
