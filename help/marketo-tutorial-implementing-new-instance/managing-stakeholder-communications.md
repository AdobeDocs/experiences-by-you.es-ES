...
Implementar Marketo Engage es un momento crítico para aumentar su pila de MarTech. Podría incluir a varias partes interesadas que debe llevar desde el marketing hasta las ventas y la TI. Aprenda a obtener asistencia de su organización para la nueva instancia de Marketo Engage haciendo las preguntas correctas y comunicando las actualizaciones y la asistencia necesarias regularmente. Utilice el tutorial y las plantillas (con versiones descargables) para guiar las comunicaciones internas a través de la implementación y la incorporación del usuario.

## Participación de las partes interesadas y los responsables en la implementación de su Marketo Engage

### Acción 1: alinearse con el liderazgo y las partes interesadas para conectar las capacidades de los Marketo Engage con sus objetivos

Inicie la implementación alineándose con los líderes y las prioridades de las partes interesadas en marketing y ventas, y eduque a los líderes en cómo Marketo Engage les ayudará a lograrlas. Estas son algunas preguntas clave que puede utilizar para interactuar con los líderes y las partes interesadas:
...
¡Buenas noticias! A partir de esta semana, hemos comenzado a incorporar al Marketo Engage. La integración de esta tecnología de automatización de marketing en nuestra pila de MarTech proporcionará <i>[NOMBRE DE EMPRESA]</i> a un nivel completamente nuevo. Con nuestro enfoque en <i>[METAS DE MARKETING]</i>, Marketo Engage nos permite organizar y ejecutar campañas en canales múltiples para adquirir, alimentar, ampliar y retener clientes.

Nuestras prioridades durante esta implementación serán las siguientes <i>[PRIORIDADES DE INCORPORACIÓN]</i>. Aunque anticipamos un proceso fluido, queremos señalar que ,<i>[POSIBLES OBSTÁCULOS]</i> puede requerir un poco de tiempo y de inversión adicionales. Para completar este proceso de la manera más eficiente y eficaz posible, mi equipo agradecería <i>[TAREAS DE LOS ACCIONISTAS]</i>. Gracias por su continuo apoyo a este esfuerzo y por su inversión en <i>[NOMBRE DE EMPRESA]</i>El éxito de.
...
¡Buenas noticias! A partir de esta semana, hemos comenzado a incorporar la plataforma de participación de Marketo. La integración de esta tecnología de automatización de marketing en nuestra pila de MarTech proporcionará <i>[nuestra empresa]</i> a un nivel completamente nuevo. Con nuestro enfoque en <i>[ampliar nuestros esfuerzos de marketing para atraer a más representantes de ventas, clientes potenciales de mayor calidad]</i>, el Marketo Engage nos permitirá <i>[automatice muchos de nuestros procesos, cree una estructura de puntuación de posible cliente/persona personalizada y nutra posibles clientes para garantizar que estén listos para comprar cuando lleguen al equipo de ventas]</i>.

Nuestras prioridades durante esta implementación serán las siguientes <i>[integrar nuestros CRM y desarrollar nuestros programas de nutrición de clientes potenciales]</i>. Mientras que anticipamos un proceso suave, <i>[posibles desafíos, por ejemplo, reforzar la higiene de los datos y la falta de una estrategia clara de puntuación de posibles clientes]</i> puede requerir un poco de tiempo y de inversión adicionales. Para completar este proceso de la manera más eficiente y eficaz posible, mi equipo agradecería <i>[su apoyo en la participación de operaciones de ventas para ayudarnos a limpiar nuestros datos. su equipo de liderazgo de ventas para crear una estrategia integral de puntuación de posible cliente/persona.]</i>. Gracias por su continuo apoyo a este esfuerzo y por su inversión en <i>[nuestro negocio]</i>El éxito de.

Mejor,
<i>[NOMBRE/Operación de marketing]</i>
</td> 
</tr>
</table>
...
1. Campaña de correo electrónico segmentada correcta
   * Nombre del programa: <i>[Nombre de campaña]</i>
   ...
   * Aprendizajes clave: <i>[Comparta cualquier perspectiva o lección aprendida de la campaña]</i>
2. Flujo de trabajo optimizado de nutrición de clientes potenciales
   * Nombre del programa: <i>[Nombre del flujo de trabajo]</i>
   ...
   * Resultados:
   * Mayor participación del posible cliente: <i>[Describa cualquier mejora en las métricas de participación de posibles clientes, como tasas de respuesta más altas, progresión más rápida de posibles clientes, etc.]</i>
   * Ahorro de tiempo: <i>[Mencione los beneficios que le ahorrarán tiempo gracias a la automatización]</i>
   * Aprendizajes clave: <i>[Comparta las perspectivas obtenidas al optimizar el flujo de trabajo]</i>

Estos éxitos son un testimonio de la dedicación de nuestro equipo y de las capacidades de los Marketo Engage para impulsar una participación dirigida y una automatización eficiente. Muestran el impacto positivo que nuestros esfuerzos ya están teniendo en nuestros esfuerzos de marketing.
...
1. Éxito de campaña de correo electrónico segmentada: nuestra reciente campaña de correo electrónico <i>[promoción del lanzamiento de un nuevo producto]</i>, implementado con Marketo Engage, ha conseguido un rendimiento notable <i>[con una tasa de apertura del 50 % y una tasa de conversión del 10 %]</i>. Esta campaña no solo comprometió a nuestra audiencia de manera efectiva, sino que también contribuyó significativamente a nuestros objetivos generales de generación de clientes potenciales.

2. Eficiencia del flujo de trabajo automatizado: al aprovechar las capacidades de automatización de Marketo Engage, hemos optimizado nuestro flujo de trabajo de nutrición de clientes potenciales, lo que da como resultado <i>[una reducción de 3 días en el tiempo de respuesta y un aumento del 10 % en las tasas de conversión de plomo]</i>. Esta mejora de la eficiencia ha tenido un impacto tangible en nuestros resultados y en la satisfacción del cliente.
...
<i>[Enumere los hitos del proyecto y el estado de la tarea relevantes. Actualice el progreso según sea necesario.]</i>

Nuestro sincero agradecimiento a <i>[EQUIPO]</i> por su ayuda con <i>[RETO]</i>. Para completar nuestros próximos pasos de manera oportuna, necesitaremos lo siguiente <i>[TAREAS DEL ACCIONISTA]</i>.

Gracias por su continuo apoyo a este esfuerzo y por su inversión en <i>[NOMBRE DE EMPRESA]</i>El éxito de.
...
Definir estrategia de puntuación de posible cliente/persona - <i>[Completado/En curso/No iniciado]</i>
Asignar campos de Marketo Engage de CRM - <i>[Completado/En curso/No iniciado]</i>
Integración de Salesforce con Marketo Engage: <i>[Completado/En curso/No iniciado]</i>
Generar programa de primer Marketo Engage - <i>[Completado/En curso/No iniciado]</i>

Nuestro sincero agradecimiento a [el equipo de operaciones de ventas] por su ayuda con [colaboración, por ejemplo, nuestra asignación de campos de Salesforce-Marketo Engage]. Nuestras prioridades a partir de ahora serán finalizar nuestra estrategia de puntuación de posibles clientes y comenzar a crear una estrategia de puntuación de posibles clientes en Marketo, así como integrar CRM y Marketo Engage.

Gracias por su continuo apoyo a este esfuerzo y por su inversión en <i>[la de nuestra empresa]</i> éxito.
...
Descargue y utilice el [Guía y plantilla de comunicaciones internas de incorporación](/help/marketo-tutorial-implementing-new-instance/assets/marketo-engage-new-instance-onboarding-internal-communications-guide-template.xlsx){target="_blank} para crear actualizaciones regulares e informar sobre el progreso a las partes interesadas. Incluya métricas clave, logros y próximos hitos para mantenerlos informados y comprometidos.
