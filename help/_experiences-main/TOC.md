...
+ [!DNL Analytics] por usted {#analytics}
   ...
   + Introducción a [!DNL Analytics] {#intro-to-analytics}
      + Transición desde otras plataformas {#transitioning-from-other-platforms}
         + [En transición desde  [!DNL Google Analytics]](../analytics/intro-to-analytics/transitioning-from-other-platforms/transition-from-google-analytics.md)
   + Analysis Workspace {#analysis-workspace}
      + Usando paneles {#using-panels}
   ...
   + Administración {#administration}
      + Aptitudes clave de administrador {#key-admin-skills}
         ...
         + [Traducir  [!DNL Adobe Analytics] idioma técnico de forma no técnica](../analytics/administration/key-admin-skills/translating-adobe-analytics-technical-language.md)
      ...
      + Consejos de administración y prácticas recomendadas {#admin-tips}
         ...
         + [Crear un sitio  [!DNL Adobe Analytics] interno](../analytics/administration/admin-tips/create-an-internal-adobe-analytics-site.md)
...
+ [!DNL Campaign] por usted {#campaign}
   ...
   + Estrategia y liderazgo mental{#strategy}
      + [Diez prácticas recomendadas para  [!DNL Adobe Campaign] especialistas en marketing de éxito](/help/campaign/10-best-practices-for-marketers.md)
+ Experience Manager por usted {#experience-manager}
   ...
   + AEM as a Cloud Service {#cloud-service}
      + [Guía de incorporación de [!DNL Cloud Manager]](/help/experience-manager/cloud-service/expert-resources/aem-champions/onboarding-playbook.md)
      ...
      + Prácticas recomendadas {#cloud-manager-best-practices}
         ...
         + [Planificación de una migración a AEM as a Cloud Service](/help/experience-manager/cloud-service/expert-resources/aem-champions/migration.md)
         + [Estrategias y sugerencias de migración de Post](/help/experience-manager/cloud-service/expert-resources/aem-champions/post-migration.md)
         ...
         + [Afrontar los desafíos al migrar a AEM as a Cloud Service](/help/experience-manager/cloud-service/expert-resources/aem-champions/migration-challenges.md)
+ [!DNL Marketo Engage] por usted {#marketo-engage}
   ...
   + Aspectos básicos {#fundamentals}
      ...
      + [Auditar una instancia heredada: tutorial](https://experienceleague.adobe.com/docs/experiences-by-you/auditing-an-inherited-instance/overview.html)
